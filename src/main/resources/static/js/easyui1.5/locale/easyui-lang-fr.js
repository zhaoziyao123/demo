...
if ($.fn.datagrid) {
    $.fn.datagrid.defaults.loadMsg = "Traitement, s"
    il
    vous
    plaît
    patienter...
...
if ($.fn.validatebox) {
    $.fn.validatebox.defaults.rules.email.message = "S"
    il
    vous
    plaît
    entrer
    ...
    valide.
    ";
    $.fn.validatebox.defaults.rules.url.message = "S"
    il
    vous
    plaît
    entrer
    ...
    valide.
    ";
    $.fn.validatebox.defaults.rules.length.message = "S"
    il
    vous
    plaît
    entrez
...
if ($.fn.datebox) {
    $.fn.datebox.defaults.currentText = "Aujourd"
    hui
    ";
