...
(function ($) {
    ...
    var showSortModal = function (that) {
        ...
        if (!$(_id).hasClass("modal")) {
            ...
            " + _id + "
            Label
            ">" + that.options.formatMultipleSort() + "</h4>";
            sModal += "                 </div>";
            sModal += "                 <div class="
            modal - body
            ">";
        ...
        default
            ...
            "></i> " + that.options.formatAddLevel() + "</button>";
            sModal += "                                     <button id="
            delete " type="
            button
            " class="
        ...
        default
            ...
            "></i> " + that.options.formatDeleteLevel() + "</button>";
            sModal += "                                 </div>";
            sModal += "                             </div>";
            sModal += "                         </div>";
            sModal += "                         <div class="
            ...
            sModal += "                                         <th><div class="
            th - inner
            ">" + that.options.formatColumn() + "</div></th>";
            sModal += "                                         <th><div class="
            th - inner
            ">" + that.options.formatOrder() + "</div></th>";
            sModal += "                                     </tr>";
            sModal += "                                 </thead>";
            sModal += "                                 <tbody></tbody>";
            sModal += "                             </table>";
        ...
        default
            " data-dismiss="
            modal
            ">" + that.options.formatCancel() + "</button>";
            sModal += "                     <button type="
            button
            " class="
            btn
            btn - primary
            ">" + that.options.formatSort() + "</button>";
            sModal += "                 </div>";
            sModal += "             </div>";
            sModal += "         </div>";
            sModal += "     </div>";
            ...
            that.$sortModal.off("click", ".btn-primary").on("click", ".btn-primary", function () {
                ...
                if (results.length > 0) {
                    if ($alert.length === 0) {
                        ...
                        " role="
                        alert
                        "><strong>" + that.options.formatDuplicateAlertTitle() + "</strong> " + that.options.formatDuplicateAlertDescription() + "</div>";
    ...
    .
        ...
        $.each(this.columns, function (i, column) {
            ...
            $multiSortName.append("<option value="
            " + column.field + "
            ">" + column.title + "</option>"
        )
            ;
        ...
        $.each(this.options.formatSortOrders(), function (value, order) {
            $multiSortOrder.append("<option value="
            " + value + "
            ">" + order + "</option>"
        )
            ;
        ...
        if (sortPriority !== undefined) {
            $multiSortName.find("option[value="
            " + sortPriority.sortName + "
            "]"
        ).
            attr("selected", true);
            $multiSortOrder.find("option[value="
