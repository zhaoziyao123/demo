...
(function (factory) {
    ...
    $h = {
        ...
        STYLE_SETTING: "style="width: {width};
    height:{
        height
    }
    ;"",
...
,
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            " {status}>{icon} {label}</a>";
            //noinspection HtmlUnknownAttribute
            tBtnBrowse = "<div tabindex="
            500
            " class="
            {
                css
            }
            " {status}>{icon} {label}</div>";
            tModalMain = "<div id="
            " + $h.MODAL_ID + "
            " class="
            file - zoom - dialog
            ...
            kv - zoom - actions
            pull - right
            ">{toggleheader}{fullscreen}{borderless}{close}</div>\n" +
            "      <h3 class="
            modal - title
            ">{heading} <small><span class="
            kv - zoom - title
            "></span></small></h3>\n" +
            "    </div>\n" +
            "    <div class="
        ...
        %
            ...
            "";
            tTagBef1 = tTagBef + "><div class="
            kv - file - content
            ">\n";
            tTagBef2 = tTagBef + " title="
            {
                caption
            }
            "><div class="
        ...
        _getZoomButton: function (type) {
            ...
            ") + "
            " ",
                params = title + (type === "close" ? " data-dismiss="modal
            " aria-hidden="
            true
            ""
        :
        ...
        _validateDefaultPreview: function () {
            ...
            self.$preview.html("<div class="
            file -
        default
            -preview
            ">" + self.defaultPreviewContent + "</div>"
        )
            ;
            self.$container.removeClass("file-input-new");
            self._initClickable();
            ...
            $preview.find($h.FRAMES + " .kv-file-remove").each(function () {
                ...
                self._handler($el, "click", function () {
                    ...
                    $frame.fadeOut("slow", function () {
                        ...
                        $frame.remove();
                        if (id && hasError) {
                            self.$errorContainer.find("li[data-file-id="
                            " + id + "
                            "]"
                        ).
        ...
        _renderThumbProgress: function () {
            ...
            file - thumb - progress
            hide
            ">" + self.progressTemplate.replace(/\{percent}/g, "0")
        ...
        _renderFileActions: function (showUpload, showDelete, showZoom, showDrag, disabled, url, key, isInit) {
            ...
            var self = this,
                vUrl = url === false ? "" : " data-url="
            " + url + "
            "",
                vKey = key === false ? "" : " data-key="
            " + key + "
            "",
        ...
        zoom: function (frameId) {
            ...
            if (!$frame.length) {
                self._log("Cannot zoom to detailed preview! Invalid frame with id: "
                " + frameId + "
                "."
            )
                ;
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgSizeTooSmall: "File "
    {
        name
    }
    " (<b>{size} KB</b>) is too small and must be larger than <b>{minSize} KB</b>.",
        msgSizeTooLarge
:
    "File "
    {
    ...
    " (<b>{size} KB</b>) exceeds maximum allowed upload size of <b>{maxSize} KB</b>.",
        msgFilesTooLess
:
...
:
    ...
    " not found!",
        msgFileSecured
:
    "Security restrictions prevent reading the file "
    {
        name
    }
    ".",
...
:
    ...
    ".",
        msgInvalidFileName
:
    "Invalid or unsupported characters in file name "
    {
        name
    }
    ".",
